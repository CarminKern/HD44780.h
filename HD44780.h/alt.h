...
#		define PRINT_ERROR_FUNCTIONSET_INVALID_DL				printf("FUNKTIONS EINSTELLUNGEN - EINGABEFEHLER - Ungueltige Datenlaenge");
#		define PRINT_ERROR_FUNCTIONSET_INVALID_N				printf("FUNKTIONS EINSTELLUNGEN - EINGABEFEHLER - Ungueltige Zeilenanzahl");
#		define PRINT_ERROR_FUNCTIONSET_INVALID_F				printf("FUNKTIONS EINSTELLUNGEN - EINGABEFEHLER - Ungueltige Pixelgroesse");

#		define PRINT_ERROR_DATASEND_INVALID(port)			printf("DATEN SENDUNG - Ungueltiger Port %s", port);
...
#		define GPIO_SET(pin,var)							if(var==0){GPIO_OFF(pin)}else{GPIO_ON(pin)};
#
#	else
...
#
#		define GPIO_SET_OUT(port,pin)						PRINT_TEST PRINT_GPIO_SET_OUT(port,pin) GPIO_OFF(pin)
#   	define GPIO_SET_IN(port,pin)						PRINT_TEST PRINT_GPIO_SET_IN(port,pin) GPIO_OFF(pin)
...
#define ERROR_FUNCTIONSET_INVALID_DL						PRINT_ERROR PRINT_ERROR_FUNCTIONSET_INVALID_DL
#define ERROR_FUNCTIONSET_INVALID_N							PRINT_ERROR PRINT_ERROR_FUNCTIONSET_INVALID_N
#define	ERROR_FUNCTIONSET_INVALID_F							PRINT_ERROR PRINT_ERROR_FUNCTIONSET_INVALID_F

#define ERROR_DATASEND_INVALID(port)						PRINT_ERROR PRINT_ERROR_DATASEND_INVALID(port)
